...
## [Switch](http://heathbrothers.com/books/switch/)
...
1. Is there a Prompt? (Action prompts are more reliable than Person or Context Prompts)
2. Is there an Ability blocker? (Make the Behaviour easier. Check time, money, physical effort, mental effort, routine)
3. Is there enough Motivation? (It's unreliable. Motivation towards an abstract doesn't work.)

## Bonus: "Tripping over the truth"

From [The Power Of Moments](https://heathbrothers.com/books/the-power-of-moments/)

Viscerally seeing, feeling, the scale and scope of the problem.<br>
To motivate toward and appreciate a solution.<br>
