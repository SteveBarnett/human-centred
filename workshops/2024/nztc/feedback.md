...
- The venue, set-up, and food were great.
    - More clear labelling on urns, have water in the room too.
- Captions on separate screen from slides would have been clearer.
- Correct start time on tickets!

### For Steve

- List of useful resources was good, in particular there's lots of it, and that it's available after the workshop.
- Add a list of common accessibility issues.
- Good structure, cadence, and balance of the workshop.
- Improve the clarity of the course agenda, the path through the material.
- More presenting, in particular more demos of auditing and of screen reader usage.
- More presenting about different types of accessibility.
- More collaborative activities, less time on their own.
- Steve and Prae wandering around helping was good.
- Informed, approachable, helpful, facilitators.
- Explanations were clear and easy to understand.

<div class="boxout">
<p>If I ran this again, I would:</p>
<ul>
    <li>Make workshop pages a different visual style from the rest of the site.</li>
    <li>Make workshop outline more structured.</li>
    <li>Add demos, especially QAC (axe, keyboard, headings) and screen readers, maybe of the audit process as a whole.</li>
    <li>Add some group activities.</li>
    <li>Add a bit about common a11y issues, probably with WebAIM Million.</li>
</ul>
</div>
...
- Hands-on experience, tangible experience
- Well structured memorable content
- Good thoroughness
- Content to come back to
- Knowledgable speaker
- Wider perspective on the topic
- Amazing food
- Cadence of the workshop
- Good structure, didn't feel to rushed or slow
- Good balance of theory and practice
- Plenty of opportunity to test things that we learnt
- Approachability of the humans running the workshop
- Specific demos e.g. VoiceOver, specific attributes
- Also good to explore tools on their own
- Activities as intro to deeper discussion on a particular topic
- Steve around to answer questions
- moving around the room to help people out worked well
- most practical value from practical, real-life, discussions
- New perspectives
- Good facilitators, very informed and happy to answer any questions in a comprehensive manner.
- approachable and genuine so it was easy to ask questions
- The resources provided were really useful
- the audit process breakdown was particularly good as it included links to tools that would streamline some of the checks
- Loads of useful information
- Really like that there were heaps of awesome resources to go through
- Having the useful links and content to refer to later will be an asset
- Helpful links/resources
- Many chances to ask questions specific to our projects/work items
- Lots of industry knowledge from the presenters
- spoke well and explained things in a great way that was easy to grasp
- clear that he is very passionate about this topic.
- great venue
- great venue and set up
- knowledgeable and personable, presents information in a very easy to understand way
- informal humourous presentation style


### What could we change? Δ

- Have more activities as intro to deeper discussion on a particular topic
- savoury GF/DF snack too
- Use "what good / bad looks like" instead of attendees own work
- examples demonstrating and highlighting good and bad practices for different steps of the audit process
- start time on tickets
- labelling on urns
- more clear, less dense, navigation on content
- got lost trying to set up Discord, lost time
- got lost knowing which page to go to
- more guidance and demos from Steve
- more of Steve presenting
- less open agenda, more guidance on path through the material
- water in the room, not just downstairs
- more collaborative activities
- more presenting about different types of accessibility
- captions on separate screen from slides

### Anything else? ☺️

- good introduction to accessibility testing
- list of useful resources was good
- more structured guidance on specific situations
- add a list of common accessibility issues
- amazing to see the Testing community get reinvigorated again after a long hiatus
- A follow up session for this topic would be epic
- All in all a very good maiden voyage
